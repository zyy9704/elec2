...
<td width="35%" class="ta_01" bgColor="#ffffff">
		...
		<c:forEach items="${jctid}" var="jct">
            <c:if test="${jct.ddlname==siteInfoView.jctid}">
                <option value="${jct.ddlname}" selected>${jct.ddlname}</option>
            </c:if>
            <c:if test="${jct.ddlname!=siteInfoView.jctid}">
                <option value="${jct.ddlname}" >${jct.ddlname}</option>
            </c:if>
...
<td width="35%" class="ta_01" bgColor="#ffffff">
<input name="stationName" type="text" id="stationName"  size="20" maxlength="25" value="${siteInfoView.stationname}"> <font color="#FF0000">*</font></td>
</tr>
<tr> 
  <td width="15%" height="22" align="center" bgColor="#f5fafe" class="ta_01">站点代号：</td>
  <td width="35%" class="ta_01" bgColor="#ffffff"><input name="stationCode" type="text" id="Text2"  size="20" maxlength="25" value="${siteInfoView.stationcode}"> <font color="#FF0000">*</font></td>
  <td width="15%" height="22" align="center" bgColor="#f5fafe" class="ta_01">使用时间：</td>
  <td width="35%" class="ta_01" bgColor="#ffffff" height="30">
  <input name="useStartDate" type="text"  size="20" value="${siteInfoView.usestartdate}" onclick="WdatePicker()"></td>
 </tr>
<tr> 
  <td width="15%" height="22" align="center" bgColor="#f5fafe" class="ta_01">安装地点：</td>
  <td width="35%" class="ta_01" bgColor="#ffffff">
  <input name="jcfrequency" type="text" id="jcfrequency"  size="20" maxlength="50" value="${siteInfoView.jcfrequency}"></td>
  <td width="15%" height="22" align="center" bgColor="#f5fafe" class="ta_01">生产厂家：</td>
  <td width="35%" class="ta_01" bgColor="#ffffff">
   <input name="produceHome" type="text" id="produceHome"  size="20" maxlength="25" value="${siteInfoView.producehome}"></td>
 </tr>
 <tr> 
  <td width="15%" height="22" align="center" bgColor="#f5fafe" class="ta_01">通讯方式：</td>
  <td width="35%" class="ta_01" bgColor="#ffffff">
  <input name="contactType" type="text" id="contactType"  size="20" maxlength="25" value="${siteInfoView.contacttype}"></td>
  ...
  <td  width="35%" class="ta_01" bgColor="#ffffff" height="30">
					...
					<option value="0">全部</option>
                        ...
                        <c:forEach items="${stationType}" var="type">
                            ...
                            <c:if test="${type.ddlname==siteInfoView.stationtype}">
...
<tr> 
  ...
  <td width="35%" class="ta_01" bgColor="#ffffff"><input name="contactType" type="text" id="contactType"  size="20" maxlength="25" value="${siteInfoView.attributionground}"></td>
...
<tr>
	...
	<td width="85%" class="ta_01" bgcolor="#ffffff" colspan="3">
		<textarea name="comment" id="comment" style="width:100%" style="word-break: break-all"  rows="4">${siteInfoView.comment}</textarea></td>
</tr>
