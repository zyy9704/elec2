...
//            Pub.submitActionWithForm('Form1',path,'Form1');
        ...
        function exeportExcel(){
            ...
            var path="/downLoadSiteInfo.html?jct="+document.Form1.jct.value+"&stationCode="+stationCode+"&stationType="+document.Form1.stationType.value+"&contactType="+document.Form1.contactType.value+"&stationName="+stationName+"&attributionGround="+document.Form1.attributionGround.value;
					...
					<tr>
						...
						<td class="ta_01" >
							<select name="jct" id="jct" style="width:160px"  onchange="getStation(this)">
								...
								<c:forEach items="${jctid}" var="unit" varStatus="vs">
									<option value="${unit.ddlname}">${unit.ddlname}</option>
								</c:forEach>
						...
						<td class="ta_01" >
							...
							<select name="stationName" id="stationName" style="width:160px">
								...
								<c:forEach items="${stationName}" var="siteName" varStatus="vs">
									<option value="${siteName.ddlname}">${siteName.ddlname}</option>
								</c:forEach>
							</select></td>
					</tr>
					<tr>
						...
						<td class="ta_01"  height="30">&nbsp;
							<select name="stationType" id="stationType" style="width:160px">
								<option value="">全部</option>
								<c:forEach items="${stationType}" var="siteCategory" varStatus="vs">
									<option value="${siteCategory.ddlname}">${siteCategory.ddlname}</option>
								</c:forEach>
