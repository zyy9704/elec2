...
//      jctid devName planDatef planDatet devType
  ...
  function  searchplan(){
     changeformvalue();
     Pub.submitActionWithForm('Form1','/queryData.html','Form1');
				...
				<td width="100" class="ta_01" align="center" bgcolor="#f5fafe" height="22">设备类型：</td>
								<td class="ta_01"  width="247">
									...
									<option value="">全部</option>
										...
										<c:forEach items="${devtypes}" var="type" >
											<option value="${type.ddlname}">
												${type.ddlname}
											</option>
										</c:forEach>
	 ...
	 <TR>
		<TD align="center" background="${pageContext.request.contextPath }/images/cotNavGround.gif" width="25"><img src="${pageContext.request.contextPath }/images/yin.gif" width="15"></TD>
			...
			<td class="ta_01" align="right"  >
				...
				<input type="button" name="BT_ex" value="导出设置"  id="BT_ex"  onClick="openWindow('planExportView.html?XorJ=J','600','400');" style="font-size:12px; color:black; height=20;width=80">
							...
							<c:forEach items="${pageBean.beans}" var="plan" varStatus="vs">
								<tr onMouseOver="this.style.backgroundColor = 'white'" onMouseOut="this.style.backgroundColor = '#F5FAFE';">
									...
									<td align="center"  width="22%">
										<a href="javascript:;" onClick="openWindow('planView.jsp?editflag=0&devPlanId=${plan.devplanid}',800,450,'设备详细信息');" class="cl_01">${plan.devname}</a></td>
