<%@ page import="com.itszt.elec8.ConstantsKeys" %>
<%@ page import="java.util.TreeSet" %>
<%@ page import="com.itszt.elec8.domain.ElecPopedom" %>
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
<%@ taglib prefix="hehe" uri="http://itszt.popedom/jstl/fake" %>
...
<HTML>
	<HEAD>
		...
		function changetype(){
		  ...
		  if(document.Form1.keyword.value=="blank"){
