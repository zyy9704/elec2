						...
						<td align=center background="${pageContext.request.contextPath}/images/index.jpg">
							<table border="0" width="98%" id="table3" height="412" cellspacing="0" cellpadding="0">
									...
									<td height="99" width="27%">
										<table border="0" width="70%" id="table4">
											<tr>
												...
												<td><input type="text" name="name" style="width: 125px" size="20" value=""  maxlength="25"></td>

											</tr>
											<tr>
												<td width="100"><img border="0" src="${pageContext.request.contextPath}/images/mima.jpg" width="75" height="20"></td>
												<td><input type="password" name="password" style="width: 125px" size="20" value="admin"  maxlength="25"></td>
								...
								-->
											<tr>
												<td width="100"></td>
												<td width="100"><input type="button" class=btn_mouseout onmouseover="this.className='btn_mouseover'" onmouseout="this.className='btn_mouseout'" value="登   录 ${resultInfo}" name="huifubtn" onclick="checkFunction()"></td>
